...
# Import detection utilities from extracted modules
from core.detectors import detect_code_language, is_code_content, is_dax_content, is_python_content
from core.docx.parser import detect_header_level
