USE [USCTTDEV]
GO
/****** Object:  StoredProcedure [dbo].[sp_BidAppAddAndUpdate]    Script Date: 3/26/2020 11:09:58 AM ******/
SET ANSI_NULLS ON
GO
...
BEGIN
	...
	*/
	...
	+ CASE WHEN @NewRateCount > 0 THEN '<p><H3>New Rates</H3> <table border = 1>' +@HeadersTM + @NewRates + '</table></p>' ELSE '' END
