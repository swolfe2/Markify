USE [USCTTDEV]
GO
/****** Object:  StoredProcedure [dbo].[sp_USBank2]    Script Date: 3/24/2021 10:25:30 AM ******/
SET ANSI_NULLS ON
GO
...
Act_Fuel = usbcp.Act_FuelFinal,
Act_Linehaul = usbcp.Act_LinehaulFinal,
Act_ZUSB = usbcp.Act_ZUSBFinal
FROM USCTTDEV.dbo.tblActualLoadDetail ald
INNER JOIN ##tblUSBankChargePivot usbcp ON usbcp.LD_LEG_ID = ald.LD_LEG_ID
WHERE usbcp.Matches = 'Yes'
