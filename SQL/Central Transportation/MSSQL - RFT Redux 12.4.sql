...
ALTER TABLE ##tblActualLoadDetailsRFT DROP COLUMN IF EXISTS LOPlannedStatus
ALTER TABLE ##tblActualLoadDetailsRFT DROP COLUMN IF EXISTS LOPlannedDesc
ALTER TABLE ##tblActualLoadDetailsRFT DROP COLUMN IF EXISTS LOPlannedOn
ALTER TABLE ##tblActualLoadDetailsRFT DROP COLUMN IF EXISTS LOPlannedUserID
ALTER TABLE ##tblActualLoadDetailsRFT DROP COLUMN IF EXISTS LOPlannedCount
ALTER TABLE ##tblActualLoadDetailsRFT DROP COLUMN IF EXISTS LOTenderedStatus
ALTER TABLE ##tblActualLoadDetailsRFT DROP COLUMN IF EXISTS LOTenderedDesc
ALTER TABLE ##tblActualLoadDetailsRFT DROP COLUMN IF EXISTS LOTenderedOn
ALTER TABLE ##tblActualLoadDetailsRFT DROP COLUMN IF EXISTS LOTenderedUserID
ALTER TABLE ##tblActualLoadDetailsRFT DROP COLUMN IF EXISTS LOTenderedCount

ALTER TABLE ##tblActualLoadDetailsRFT ADD LOPlannedStatus     NVARCHAR(10)   --##tblLightsOutPlanned.PLND_STATUS
ALTER TABLE ##tblActualLoadDetailsRFT ADD LOPlannedDesc       NVARCHAR(300)  --##tblLightsOutPlanned.PLND_STATUS_DESC
ALTER TABLE ##tblActualLoadDetailsRFT ADD LOPlannedOn         DATETIME       --##tblLightsOutPlanned.PLND_MNT_TMESTMP
ALTER TABLE ##tblActualLoadDetailsRFT ADD LOPlannedUserID     NVARCHAR(30)   --##tblLightsOutPlanned.PLND_USER_ID
ALTER TABLE ##tblActualLoadDetailsRFT ADD LOPlannedCount      INT            --##tblLightsOutPlanned.PLND_PROCSSD_CNT
ALTER TABLE ##tblActualLoadDetailsRFT ADD LOTenderedStatus    NVARCHAR(10)   --##tblLightsOutTendered.TDR_STATUS
ALTER TABLE ##tblActualLoadDetailsRFT ADD LOTenderedDesc      NVARCHAR(300)  --##tblLightsOutTendered.TDR_STATUS_DESC
ALTER TABLE ##tblActualLoadDetailsRFT ADD LOTenderedOn        DATETIME       --##tblLightsOutTendered.TDR_MNT_TMESTMP
ALTER TABLE ##tblActualLoadDetailsRFT ADD LOTenderedUserID    NVARCHAR(30)   --##tblLightsOutTendered.TDR_USR_ID
ALTER TABLE ##tblActualLoadDetailsRFT ADD LOTenderedCount     INT            --##tblLightsOutTendered.TDR_PROCSSD_CNT
...
*/
ALTER TABLE ##tblActualLoadDetailsRFT DROP COLUMN IF EXISTS AppointmentDeleted
ALTER TABLE ##tblActualLoadDetailsRFT DROP COLUMN IF EXISTS ConfirmReversal
ALTER TABLE ##tblActualLoadDetailsRFT DROP COLUMN IF EXISTS DockChanged
ALTER TABLE ##tblActualLoadDetailsRFT DROP COLUMN IF EXISTS DockCreated
ALTER TABLE ##tblActualLoadDetailsRFT DROP COLUMN IF EXISTS DockDeleted
ALTER TABLE ##tblActualLoadDetailsRFT DROP COLUMN IF EXISTS LoadUnsuspended
ALTER TABLE ##tblActualLoadDetailsRFT DROP COLUMN IF EXISTS ManuallyAccepted
ALTER TABLE ##tblActualLoadDetailsRFT DROP COLUMN IF EXISTS ManuallyPlanned
ALTER TABLE ##tblActualLoadDetailsRFT DROP COLUMN IF EXISTS ManuallyTendered
ALTER TABLE ##tblActualLoadDetailsRFT DROP COLUMN IF EXISTS TenderCancelled
ALTER TABLE ##tblActualLoadDetailsRFT DROP COLUMN IF EXISTS TenderRejected
ALTER TABLE ##tblActualLoadDetailsRFT DROP COLUMN IF EXISTS TotalTouches
ALTER TABLE ##tblActualLoadDetailsRFT DROP COLUMN IF EXISTS TotalProcessTouches
ALTER TABLE ##tblActualLoadDetailsRFT DROP COLUMN IF EXISTS FirstFailure

ALTER TABLE ##tblActualLoadDetailsRFT ADD AppointmentDeleted  INT  
ALTER TABLE ##tblActualLoadDetailsRFT ADD ConfirmReversal     INT
ALTER TABLE ##tblActualLoadDetailsRFT ADD DockChanged         INT
ALTER TABLE ##tblActualLoadDetailsRFT ADD DockCreated         INT
ALTER TABLE ##tblActualLoadDetailsRFT ADD DockDeleted         INT
ALTER TABLE ##tblActualLoadDetailsRFT ADD LoadUnsuspended     INT
ALTER TABLE ##tblActualLoadDetailsRFT ADD ManuallyAccepted    INT
ALTER TABLE ##tblActualLoadDetailsRFT ADD ManuallyPlanned     INT
ALTER TABLE ##tblActualLoadDetailsRFT ADD ManuallyTendered    INT
ALTER TABLE ##tblActualLoadDetailsRFT ADD TenderCancelled     INT
ALTER TABLE ##tblActualLoadDetailsRFT ADD TenderRejected      INT
ALTER TABLE ##tblActualLoadDetailsRFT ADD TotalTouches        INT
ALTER TABLE ##tblActualLoadDetailsRFT ADD TotalProcessTouches INT
ALTER TABLE ##tblActualLoadDetailsRFT ADD FirstFailure		  NVARCHAR(50)
