SELECT DISTINCT 
ald.Lane,
Rank() OVER (PARTITION BY ald.Lane, ald.LAST_SHPG_LOC_CD ORDER BY CAST(ald.SHPD_DTT AS Date) ASC ) AS Ordinal,
ald.LAST_SHPG_LOC_CD,
ald.LAST_SHPG_LOC_NAME,
ald.CustomerHierarchy,
ald.BU,
CAST(ald.SHPD_DTT AS Date) AS Date,
...
ORDER BY ald.Lane ASC, ald.LAST_SHPG_LOC_CD ASC, Ordinal ASC