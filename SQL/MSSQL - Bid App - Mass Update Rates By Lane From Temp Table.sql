...
SELECT * FROM USCTTDEV.dbo.tblBidAppChangelog WHERE Lane IN ('ALMOBILE-5CA92374',
'GAMCDONO-5CA92374',
'MSCORINT-5CA92374',
'NCOAKBOR-5CA92374' ) ORDER BY UpdatedOn DESC
*/
...
Change.NewValue
FROM (SELECT 'CAONTARI-5CA95377' AS Lane, '3.98' AS NewValue , 'HHBD' AS SCAC UNION ALL
SELECT 'CTNEWMIL-5NJ08831' AS Lane, '4.13' AS NewValue , 'HHWD' AS SCAC UNION ALL
SELECT 'KCILROME-SKIN-5UT84404' AS Lane, '1.81' AS NewValue , 'HUBG' AS SCAC
) change
