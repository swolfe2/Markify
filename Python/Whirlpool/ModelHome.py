...
# Spreadsheet ID
spreadsheetId = '16P6s0iCEGtM5_tTu4rupfs-CaXvIqqhg84nz4cAjmnU'

# Data range to create dataframe, and create raw file document
getDataRangeName = 'MHCOImport!A:BJ'
result = service.spreadsheets().values().get(
    spreadsheetId=spreadsheetId, range=getDataRangeName).execute()
values = result.get('values', [])

df = DataFrame(data=values)
df.to_excel('\\\\10.29.7.46\\c$\\Users\\wolfes\\Desktop\\Innowera Files - DO NOT DELETE\\OMAR - Model Home\\tblMHDCExcelRaw.xlsx',
...
SQLRangeName = 'Model Home SQL Data'
...
# Prints completion
print("Model Home Python Script Completed!")
