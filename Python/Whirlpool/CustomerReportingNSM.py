...
# Spreadsheet ID
spreadsheetId = '1KL-cs9wvOysGyBKYPDtVwYo_VwjKYjaT_UypF91WTUM'

# Data range to create dataframe, and create raw file document
getDataRangeName = 'Email List!A2:H'
...
df.to_excel('\\\\knx-fs1.na.ad.whirlpool.com\\Team\\TELESERV\\Continuous Improvement Db Files\\Customer Reporting\\Weekly NSM\\tblCustomerReportingNSM.xlsx',
...
df = DataFrame(data=values)
dfPathName = ""
df.to_excel('\\\\knx-fs1.na.ad.whirlpool.com\\Team\\TELESERV\\Continuous Improvement Db Files\\Customer Reporting\\Weekly NSM\\Google Sheet Archive\\Google Sheet - '+currentDateTime+'.xlsx',
            header=False, index=False)
