...
# Tableau Portal
Note, this utilizes some functions that are not visible on here, but are imported from another Python file. View the Interface with Datbase notes for more details on them.
